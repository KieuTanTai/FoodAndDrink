...
{
    public class ProductSnackRepository(IDBContext context, IMaxGetRecord maxGetRecord) : Repository<ProductSnack>(context, maxGetRecord), IProductSnackRepository
    {
