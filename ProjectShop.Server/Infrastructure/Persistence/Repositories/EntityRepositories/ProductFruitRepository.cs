...
{
    public class ProductFruitRepository(IFoodAndDrinkShopDbContext context, IMaxReturnRecordsRule maxReturnRecordsRule) : Repository<ProductFruit>(context, maxReturnRecordsRule), IProductFruitRepository
    {
