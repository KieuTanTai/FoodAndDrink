...
{
    public class ProductFruitRepository(IFoodAndDrinkShopDbContext context, IMaxGetRecord maxGetRecord) : Repository<ProductFruit>(context, maxGetRecord), IProductFruitRepository
    {
