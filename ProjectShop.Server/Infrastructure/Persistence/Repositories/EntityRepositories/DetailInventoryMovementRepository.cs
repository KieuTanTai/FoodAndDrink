...
{
    public class DetailInventoryMovementRepository(IDBContext context, IMaxGetRecord maxGetRecord) : Repository<DetailInventoryMovement>(context, maxGetRecord), IDetailInventoryMovementRepository
    {
