...
{
    public class ProductImageRepository(IFoodAndDrinkShopDbContext context, IMaxReturnRecordsRule maxReturnRecordsRule) : Repository<ProductImage>(context, maxReturnRecordsRule), IProductImageRepository
    {
