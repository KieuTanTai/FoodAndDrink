...
{
    public class ProductRepository(IFoodAndDrinkShopDbContext context, IMaxGetRecord maxGetRecord) : Repository<Product>(context, maxGetRecord), IProductRepository
    {
