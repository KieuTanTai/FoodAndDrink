...
{
    public class SaleEventRepository(IFoodAndDrinkShopDbContext context, IMaxReturnRecordsRule maxReturnRecordsRule) : Repository<SaleEvent>(context, maxReturnRecordsRule), ISaleEventRepository
    {
