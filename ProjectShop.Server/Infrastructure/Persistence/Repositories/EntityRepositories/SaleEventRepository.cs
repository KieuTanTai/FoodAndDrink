...
{
    public class SaleEventRepository(IFoodAndDrinkShopDbContext context, IMaxGetRecord maxGetRecord) : Repository<SaleEvent>(context, maxGetRecord), ISaleEventRepository
    {
