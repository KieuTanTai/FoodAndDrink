...
{
    public class ProductMeatRepository(IFoodAndDrinkShopDbContext context, IMaxGetRecord maxGetRecord) : Repository<ProductMeat>(context, maxGetRecord), IProductMeatRepository
    {
