...
{
    public class ProductMeatRepository(IFoodAndDrinkShopDbContext context, IMaxReturnRecordsRule maxReturnRecordsRule) : Repository<ProductMeat>(context, maxReturnRecordsRule), IProductMeatRepository
    {
