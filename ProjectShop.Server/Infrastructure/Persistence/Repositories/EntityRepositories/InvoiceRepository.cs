...
{
    public class InvoiceRepository(IFoodAndDrinkShopDbContext context, IMaxReturnRecordsRule maxReturnRecordsRule) : Repository<Invoice>(context, maxReturnRecordsRule), IInvoiceRepository
    {
