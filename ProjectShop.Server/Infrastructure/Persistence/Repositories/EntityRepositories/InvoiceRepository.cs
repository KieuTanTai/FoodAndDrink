...
{
    public class InvoiceRepository(IFoodAndDrinkShopDbContext context, IMaxReturnRecordsRule maxReturnRecordsRule, IDefaultPageSizeRule defaultPageSizeRule) : Repository<Invoice>(context, maxReturnRecordsRule, defaultPageSizeRule), IInvoiceRepository
    {
