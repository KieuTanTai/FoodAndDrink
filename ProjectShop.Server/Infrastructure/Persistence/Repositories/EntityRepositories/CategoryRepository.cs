...
{
    public class CategoryRepository(IFoodAndDrinkShopDbContext context, IMaxReturnRecordsRule maxReturnRecordsRule) : Repository<Category>(context, maxReturnRecordsRule), ICategoryRepository
    {
