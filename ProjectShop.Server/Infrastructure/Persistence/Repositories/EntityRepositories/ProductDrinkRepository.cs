...
{
    public class ProductDrinkRepository(IFoodAndDrinkShopDbContext context, IMaxGetRecord maxGetRecord) : Repository<ProductDrink>(context, maxGetRecord), IProductDrinkRepository
    {
