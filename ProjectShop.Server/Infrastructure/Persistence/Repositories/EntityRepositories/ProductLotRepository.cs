...
{
    public class ProductLotRepository(IFoodAndDrinkShopDbContext context, IMaxReturnRecordsRule maxReturnRecordsRule) : Repository<ProductLot>(context, maxReturnRecordsRule), IProductLotRepository
    {
