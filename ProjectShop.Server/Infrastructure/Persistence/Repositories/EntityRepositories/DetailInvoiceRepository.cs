...
{
    public class DetailInvoiceRepository(IDBContext context, IMaxGetRecord maxGetRecord) : Repository<DetailInvoice>(context, maxGetRecord), IDetailInvoiceRepository
    {
