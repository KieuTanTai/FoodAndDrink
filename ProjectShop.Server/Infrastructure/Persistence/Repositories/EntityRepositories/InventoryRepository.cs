...
{
    public class InventoryRepository(IFoodAndDrinkShopDbContext context, IMaxGetRecord maxGetRecord) : Repository<Inventory>(context, maxGetRecord), IInventoryRepository
    {
