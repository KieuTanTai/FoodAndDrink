...
{
    public class InventoryRepository(IFoodAndDrinkShopDbContext context, IMaxReturnRecordsRule maxReturnRecordsRule) : Repository<Inventory>(context, maxReturnRecordsRule), IInventoryRepository
    {
