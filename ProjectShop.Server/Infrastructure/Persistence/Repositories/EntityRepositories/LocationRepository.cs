...
{
    public class LocationRepository(IFoodAndDrinkShopDbContext context, IMaxGetRecord maxGetRecord) : Repository<Location>(context, maxGetRecord), ILocationRepository
    {
