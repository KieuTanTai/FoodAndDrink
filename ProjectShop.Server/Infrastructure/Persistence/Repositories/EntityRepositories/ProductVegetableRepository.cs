...
{
    public class ProductVegetableRepository(IDBContext context, IMaxGetRecord maxGetRecord) : Repository<ProductVegetable>(context, maxGetRecord), IProductVegetableRepository
    {
