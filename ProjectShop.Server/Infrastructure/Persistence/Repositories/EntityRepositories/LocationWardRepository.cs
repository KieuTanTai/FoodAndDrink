...
{
    public class LocationWardRepository(IFoodAndDrinkShopDbContext context, IMaxReturnRecordsRule maxReturnRecordsRule) : Repository<LocationWard>(context, maxReturnRecordsRule), ILocationWardRepository
    {
