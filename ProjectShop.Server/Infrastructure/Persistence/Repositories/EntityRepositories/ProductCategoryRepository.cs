...
{
    public class ProductCategoryRepository(IDBContext context, IMaxGetRecord maxGetRecord) : Repository<ProductCategory>(context, maxGetRecord), IProductCategoryRepository
    {
