...
{
    public class AccountRoleRepository(IFoodAndDrinkShopDbContext context, IMaxGetRecord maxGetRecord) : Repository<AccountRole>(context, maxGetRecord), IAccountRoleRepository
    {
