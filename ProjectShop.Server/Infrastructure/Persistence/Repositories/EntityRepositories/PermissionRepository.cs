...
{
    public class PermissionRepository(IFoodAndDrinkShopDbContext context, IMaxReturnRecordsRule maxReturnRecordsRule) : Repository<Permission>(context, maxReturnRecordsRule), IPermissionRepository
    {
