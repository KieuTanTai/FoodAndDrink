...
{
    public class DetailSaleEventRepository(IDBContext context, IMaxGetRecord maxGetRecord) : Repository<DetailSaleEvent>(context, maxGetRecord), IDetailSaleEventRepository
    {
