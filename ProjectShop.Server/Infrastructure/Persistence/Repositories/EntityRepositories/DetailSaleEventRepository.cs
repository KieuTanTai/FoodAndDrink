...
{
    public class DetailSaleEventRepository(IFoodAndDrinkShopDbContext context, IMaxReturnRecordsRule maxReturnRecordsRule) : Repository<DetailSaleEvent>(context, maxReturnRecordsRule), IDetailSaleEventRepository
    {
