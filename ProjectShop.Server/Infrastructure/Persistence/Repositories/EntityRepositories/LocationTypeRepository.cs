...
{
    public class LocationTypeRepository(IDBContext context, IMaxGetRecord maxGetRecord) : Repository<LocationType>(context, maxGetRecord), ILocationTypeRepository
    {
