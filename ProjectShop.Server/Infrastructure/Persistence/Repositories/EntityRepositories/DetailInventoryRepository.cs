...
{
    public class DetailInventoryRepository(IFoodAndDrinkShopDbContext context, IMaxGetRecord maxGetRecord) : Repository<DetailInventory>(context, maxGetRecord), IDetailInventoryRepository
    {
