...
{
    public class DetailInventoryRepository(IDBContext context, IMaxGetRecord maxGetRecord) : Repository<DetailInventory>(context, maxGetRecord), IDetailInventoryRepository
    {
