...
{
    public class CustomerAddressRepository(IFoodAndDrinkShopDbContext context, IMaxReturnRecordsRule maxReturnRecordsRule) : Repository<CustomerAddress>(context, maxReturnRecordsRule), ICustomerAddressRepository
    {
