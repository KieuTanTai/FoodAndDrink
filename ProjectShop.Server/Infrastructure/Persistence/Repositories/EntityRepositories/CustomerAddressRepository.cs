...
{
    public class CustomerAddressRepository(IFoodAndDrinkShopDbContext context, IMaxGetRecord maxGetRecord) : Repository<CustomerAddress>(context, maxGetRecord), ICustomerAddressRepository
    {
