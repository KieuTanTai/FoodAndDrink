...
{
    public class SaleEventImageRepository(IDBContext context, IMaxGetRecord maxGetRecord) : Repository<SaleEventImage>(context, maxGetRecord), ISaleEventImageRepository
    {
