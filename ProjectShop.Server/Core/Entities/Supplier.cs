...
{
    public class Supplier : IGetIdEntity<uint>
    {
        ...
        public LocationWard? SupplierCompanyWard { get; private set; }
        ...
        public LocationWard? SupplierStoreWard { get; private set; }
