namespace ProjectShop.Server.Core.Interfaces.IServices.IAccount
{
    ...
    {
        Task<IEnumerable<TEntity>> GetAllAsync(int? maxGetCount = null, TBoolean? options = null);
        ...
        Task<IEnumerable<TEntity>> GetByStatusAsync(bool status, int? maxGetCount = null, TBoolean? options = null);
    }
}
