...
namespace ProjectShop.Server.Core.Interfaces.IServices
{
    public interface IServiceResultFactory<TEntityCall> where TEntityCall : class
    {
        ...
        ServiceResult<TEntity> CreateServiceResult<TEntity>(TEntity data, IEnumerable<JsonLogEntry> logEntries, bool isSuccess) where TEntity : class;
        ...
        ServiceResults<TEntity> CreateServiceResults<TEntity>(IEnumerable<TEntity> data, IEnumerable<JsonLogEntry> logEntries, bool isSuccess) where TEntity : class;
    }
}
