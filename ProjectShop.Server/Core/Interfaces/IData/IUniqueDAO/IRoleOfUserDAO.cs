namespace ProjectShop.Server.Core.Interfaces.IData.IUniqueDAO
{
    ...
    {
        Task<IEnumerable<TEntity>> GetByAccountIdAsync(uint accountId, int? maxGetCount = null);
        Task<IEnumerable<TEntity>> GetByAccountIdsAsync(IEnumerable<uint> accountIds, int? maxGetCount = null);
        Task<IEnumerable<TEntity>> GetByRoleIdAsync(uint roleId, int? maxGetCount = null);
        Task<IEnumerable<TEntity>> GetByRoleIdsAsync(IEnumerable<uint> roleIds, int? maxGetCount = null);
