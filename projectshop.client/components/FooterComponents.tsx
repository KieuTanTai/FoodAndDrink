...
const Footer = () => {
     return (
          <footer id="footer-container" className="bg-gray-200 py-8 border-t border-gray-200 shadow-[0_-4px_6px_-1px_rgb(0,0,0,0.1),0_-2px_4px_-2px_rgb(0,0,0,0.1)] ">
               <section className="container mx-auto max-w-300">
                         ...
                         <div className="col-span-full md:col-span-1 lg:col-span-1">
                              <div className="mb-6">
                                   <a href="#" className="flex items-center mb-4">
                                        <Image
                                             src="/assets/images/icons/web_logo/light-novel-world.png"
                              ...
                              <div className="text-gray-600">
                                   <div className="flex items-start mb-4">
                                        <FontAwesomeIcon icon={faMapLocationDot} className="mt-1 main-color w-5 h-5" />
                                        <div className="text-sm leading-relaxed pl-4">
                                             <p>Số 110 Nguyễn Ngọc Nại, Khương Mai, Thanh Xuân, Hà Nội</p>
                                        </div>
                                   </div>
                                   <div className="flex items-center mb-4">
                                        <FontAwesomeIcon icon={faPhone} className='main-color w-5 h-5' />
                                        <p className="pl-4 text-sm">Hotline: 03 2838 xxxx</p>
                                   </div>
                                   <div className="flex items-center mb-4">
                                        <FontAwesomeIcon icon={faEnvelope} className='main-color w-5 h-5' />
                                        <p className="pl-4 text-sm">tanthi***la**@gmail.com</p>
                                   </div>
                                   <div className="flex items-center">
                                        <FontAwesomeIcon icon={faShield} className='main-color w-5 h-5' />
                         ...
                         <div className="col-span-full md:col-span-1 lg:col-span-1">
                              ...
                              <div>
                                   ...
                                   <div className="flex flex-wrap gap-2">
                                        <Image src="/assets/images/icons/payment_methods/internet_banking.jpg" alt="internet banking" className="h-10" width={60} height={40} />
                                        <Image src="/assets/images/icons/payment_methods/pay_7.jpg" alt="visa" className="h-10" width={60} height={40} />
                                        <Image src="/assets/images/icons/payment_methods/mastercard.jpg" alt="master card" className="h-10" width={60} height={40} />
                                        <Image src="/assets/images/icons/payment_methods/pay_5.jpg" alt="tiền mặt" className="h-10" width={60} height={40} />
                                        <Image src="/assets/images/icons/payment_methods/pay_4.jpg" alt="zalo pay" className="h-10" width={60} height={40} />
                                        <Image src="/assets/images/icons/payment_methods/pay_8.jpg" alt="Momo" className="h-10" width={60} height={40} />
                                   </div>
                              </div>
                         </div>
                              ...
                              <div className="mb-6">
                                   ...
                                   <div className="flex space-x-3">
                                        <a href="https://www.facebook.com/profile.php?id=100079218978533" target="_blank" rel="noopener noreferrer">
                                             <Image src="/assets/images/icons/Social_media/facebook.svg" alt="facebook" className="h-12 w-12" width={48} height={48} />
                                        </a>
                                        <a href="https://www.tiktok.com/@tlangvotri" target="_blank" rel="noopener noreferrer">
                                             <Image src="/assets/images/icons/Social_media/icons8-tiktok.svg" alt="tiktok" className="h-12 w-12" width={48} height={48} />
                                        </a>
                                        <a href="https://twitter.com/thien8224" target="_blank" rel="noopener noreferrer">
                                             <Image src="/assets/images/icons/Social_media/icons8-twitterx.svg" alt="Twitter/X" className="h-12 w-12" width={48} height={48} />
                                        </a>
                                        <a href="https://chat.zalo.me/" target="_blank" rel="noopener noreferrer">
                                             <Image src="/assets/images/icons/Social_media/icons8-zalo.svg" alt="zalo" className="h-12 w-12" width={48} height={48} />
                                        </a>
                                   </div>
                              </div>
                         </div>
